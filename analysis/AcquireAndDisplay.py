...
# I made the variable image data a global variable so that I store the last image we had when setting the focus
# This might make the code bug
global image_data

def execute_focus(folder):
    global image_data
    main()
    im = Image.fromarray(image_data)
    im.save(folder + "1.png")
        ...
        while(continue_recording):
            try:
                ...
                if image_result.IsIncomplete():
                    ...
                    #Plotting image slows down code a lot
